...
vehicle_passage_capacity = {
    'car': 1.0,         # On average, 1 car can pass per unit time
    'motorcycle': 1.5,  # Motorcycles can pass slightly faster
    'truck': 0.5,       # Trucks are slower; fewer can pass per unit time
    'bicycle': 2.0,     # Bicycles can pass very quickly
    'bus': 0.4          # Buses are slower and take more time
}
